...
-- 1/2/3 = bronze/silver/gold). Definitions live in config/badges.ts.
...
CREATE TABLE badge_awards (
  subject_type TEXT NOT NULL CHECK (subject_type IN ('drep', 'spo', 'cc', 'user')),
...
-- Generic high-water marks for incremental jobs; first consumer is the badge
-- awarding job in gov-sync.
