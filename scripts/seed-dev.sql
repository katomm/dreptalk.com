...
-- relative times in the UI always look fresh.
...
INSERT INTO dreps (drep_id, hex, has_script, status, active, deposit, voting_power, expires_epoch_no, name, bio, image_url, links, anchor_url, anchor_hash, anchor_status, registered_epoch, last_synced_at, created_at) VALUES
  ('drep1seedadahernandezxq8f7w2lk9p3m5r6t0v4y7c2e5h8j1n4q7s0u3w6', 'aada111122223333444455556666777788889999aaaabbbbccccddde', 0, 'registered', 1, '500000000', '12500000000000', 656, 'Ada Hernandez', 'Independent DRep focused on infrastructure and developer experience.', NULL, '[]', 'https://example.org/dreps/ada.jsonld', 'aa11bb22cc33dd44ee55ff660077889900aabbccddeeff001122334455667788', 'ok', 540, strftime('%s','now')*1000 - 3600000, strftime('%s','now')*1000 - 90*86400000),
  ('drep1seedliamparkq2w4e6r8t0y1u3i5o7p9a1s3d5f7g9h1j3k5l7z9x1c3', '11aa222233334444555566667777888899990000aaaabbbbccccddd1', 0, 'registered', 1, '500000000', '4200000000000', 654, 'Liam Park', 'DRep and educator. I publish a rationale for every vote I cast.', NULL, '[]', 'https://example.org/dreps/liam.jsonld', 'bb22cc33dd44ee55ff660077889900aabbccddeeff00112233445566778899aa', 'ok', 548, strftime('%s','now')*1000 - 3600000, strftime('%s','now')*1000 - 75*86400000),
  ('drep1seedmayaokaforv5b7n9m1q3w5e7r9t1y3u5i7o9p1a3s5d7f9g1h3j5', '22bb333344445555666677778888999900001111aaaabbbbccccddd2', 0, 'registered', 1, '500000000', '8900000000000', 658, 'Maya Okafor', 'Treasury hawk. Every lovelace spent should have a measurable outcome.', NULL, '[]', 'https://example.org/dreps/maya.jsonld', 'cc33dd44ee55ff660077889900aabbccddeeff00112233445566778899aabb22', 'ok', 536, strftime('%s','now')*1000 - 3600000, strftime('%s','now')*1000 - 60*86400000),
  ('drep1seedstefanvolkovk7l9z1x3c5v7b9n1m3q5w7e9r1t3y5u7i9o1p3a5', '33cc444455556666777788889999000011112222aaaabbbbccccddd3', 0, 'registered', 1, '500000000', '1400000000000', 652, 'Stefan Volkov', 'Small DRep representing long-term holders in central Europe.', NULL, '[]', 'https://example.org/dreps/stefan.jsonld', 'dd44ee55ff660077889900aabbccddeeff00112233445566778899aabbcc3344', 'ok', 552, strftime('%s','now')*1000 - 3600000, strftime('%s','now')*1000 - 45*86400000);
...
VALUES (1, 636, 0.67, 0.67, 0.6, 0.75, 0.6, 0.67, 0.67, 0.67, 0.75, 0.67, 0.51, 0.51, 0.51, 0.51, 0.51, 0.67, 7, strftime('%s','now')*1000);
