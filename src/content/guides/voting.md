...
A rationale is optional but encouraged. When you include one, it is recorded with your vote on-chain and shown on the action's Votes tab, and you can see the link to the on-chain record before you sign. A checkbox lets you also post a copy into the action's discussion thread so others can respond, that cross-post is off by default. The on-chain rationale is permanent and cannot be edited, since it reflects what was committed on-chain. A rationale written on DRepTalk is stored directly, whatever your voting power. For votes cast outside DRepTalk, the rationale document is fetched from the chain only for voters with at least 10,000 ada of voting weight. Until a linked document can be read, the vote shows Rationale unavailable. For what makes a good rationale and how to structure it, see [Writing a vote rationale](/help/writing-a-vote-rationale/).
