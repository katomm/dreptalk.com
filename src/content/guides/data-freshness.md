...
| CIP-179 surveys (definitions and response counts) | About every 5 minutes | Mirrored from the Tessera index on the discovery cron. A just-submitted answer shows as "confirming" until its transaction is indexed, usually under ten minutes. |
