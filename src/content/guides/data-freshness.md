...
| CIP-179 surveys (definitions and response counts) | About every 5 minutes | Mirrored from the Tessera index on the discovery cron. A submitted answer is counted here once the index has confirmed its transaction, usually under ten minutes. |
