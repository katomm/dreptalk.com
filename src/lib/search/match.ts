...
// errors and lets users run arbitrary query operators. ASCII and Unicode curly
// quotes are stripped, every remaining token is double-quoted (turning
// operators into literals), and the final token gets a * suffix so the palette
// matches the word still being typed. The result is bound as a query parameter.
