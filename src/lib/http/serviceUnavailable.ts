// Graceful degradation for transient database (D1) outages.
//
...
// middleware catches it and serves this friendly 503 instead of a blank 500.
// The page is fully self-contained: it inlines its own tokens and styles and
// runs no scripts and no database reads, so it renders even while the rest of
...
<title>Briefly unavailable - DRepTalk</title>
...
<main role="main">
  ...
  <div class="actions">
    ...
    <a class="btn btn-secondary" href="https://www.cloudflarestatus.com/" rel="noopener">Platform status</a>
  </div>
  <p class="note">
