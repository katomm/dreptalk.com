...
// Shared by the category sidebar and the feed/list rows, so a topic's type
// icon is identical everywhere it appears.
...
// Deliberately not a bar chart: this site shows survey participation, never
// a result figure.
